...
CSkillZoneAura::CSkillZoneAura(CGameWorld *pGameWorld, vec2 Pos, int DurationTicks, ESkillVisualStyle Style, float Radius)
	: CChildEntity(pGameWorld, CGameWorld::ENTTYPE_LASER, 0, Pos, (int)maximum(32.f, Radius))
{
	m_Center = Pos;
	m_Pos = Pos;
...
void CSkillZoneAura::PulseEffect()
{
	switch(m_Style)
	{
...
void CSkillZoneAura::SnapCenter(int SnappingClient)
{
...
void CSkillZoneAura::SnapRing(int SnappingClient)
{
...
void CSkillZoneAura::SnapOrbit(int SnappingClient)
{
...
void CSkillZoneAura::Snap(int SnappingClient)
{
